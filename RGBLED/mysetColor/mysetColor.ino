...
void setup() 
{
    ...
    lcd.print("set color");
    delay(2000);
    Serial.println("mysetColor.ino RGB lcd example");
}
...
void loop() 
{
    ...
    Serial.print("the dtaLen is ");
    Serial.println(dtaLen);
    delay(1000);
    Serial.println("here the loop");
}
...
void serialEvent()
{
    while(Serial.available())
    {
        ...
        Serial.println("the serial is avaialbe");
    }
    Serial.println("serial not avaiable");
}
